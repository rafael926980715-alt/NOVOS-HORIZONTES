        ...
        <div ref={Focalid1} className='z-300 flex flex-col justify-center items-center gap-6 min-h-screen'>
          ...
          <div className=' flex  flex-col lg:flex-row  items-center  gap-4 lg:gap-14 w-[100vw] h-[100vh] lg:w-[80vw] lg:h-[70vh] lg:py-89 lg:px-6  lg:rounded-4xl  shadow-lg border border-white/20'>
            ...
            <div className='relative z-0 lg:w-[35vw] lg:h-[70vh] w-[100vw] h-[60vh]  flex justify-center items-center'><img src={polo} className='object-cover w-full h-full lg:rounded-4xl rounded-b-4xl shadow-lg border border-white/20' />
              ...
              <div className='absolute bottom-7 flex justify-between items-center z-50  w-[70vw]  lg:w-[20vw]  rounded-full gap-10 backdrop-blur-md  p-1 border border-white/20'>  <h1 onClick={() => mudound(Focalid2)} className='text-white  py-2 rounded-full font-bold font-sans w-full text-center cursor-pointer bg-black/10 backdrop-blur-md duration-700 ease-in-out active:scale-70 shadow-lg border border-white/20 uppercase'> Ir para Polo 2</h1> </div>
            </div>
            ...
            <div className='relative  lg:w-[39vw] lg:h-[70vh]  w-[100vw] h-[100vh] rounded-4xl overflow-hidden overflow-y-auto scroll-pink lg:px-4'>
              ...
              <div className="flex flex-col gap-9">
                ...
                {
                  isLoginOpen && (
                    <div className="fixed inset-0 lg:relative lg:inset-0 flex items-center justify-center z-900">
                      ...
                      <div className="lg:relative fixed inset-0 overflow-y-auto scroll-pink ">
                        ...
                        <div className='flex flex-col justify-center items-center gap-10 h-full pb-32 pt-29 lg:pt-0 lg:pb-7 lg:rounded-4xl backdrop-blur-md bg-gradient-to-br from-yellow-600 to-yellow-600'>

                          <div className=''>
                            <button
                              onClick={() => setIsLoginOpen(false)}
                              className="lg:hidden backdrop-blur-md px-6 py-3 border border-white/20 shadow-lg rounded-full flex items-center justify-center"
                            >
                          ...
                          <div className='grid grid-cols-2 justify-center items-center gap-5  w-full'>
                            ...
                            <div className='relative'>
                              ...
                              <input type="text" name="" id="" placeholder='Nome'
                                ...
                                className='w-full  backdrop-blur-md border border-white/20 text-gray-700
        ...
        <div ref={Focalid2} className='z-300 flex flex-col justify-center items-center gap-6 min-h-screen'>
          ...
          <div className=' flex  flex-col lg:flex-row  items-center  gap-4 lg:gap-14 w-[100vw] h-[100vh] lg:w-[80vw] lg:h-[70vh] lg:py-89 lg:px-6  lg:rounded-4xl  shadow-lg border border-white/20'>
            ...
            <div className='relative z-0 lg:w-[35vw] lg:h-[70vh] w-[100vw] h-[60vh]  flex justify-center items-center'><img src={polo} className='object-cover w-full h-full lg:rounded-4xl rounded-b-4xl shadow-lg border border-white/20' />
              ...
              <div className='absolute bottom-7 flex justify-between items-center z-50  w-[70vw]  lg:w-[20vw]  rounded-full gap-10 backdrop-blur-md  p-1 border border-white/20'>  <h1 onClick={() => mudound(Focalid1)} className='text-white  py-2 rounded-full font-bold font-sans w-full text-center cursor-pointer bg-black/10 backdrop-blur-md duration-700 ease-in-out active:scale-70 shadow-lg border border-white/20 uppercase'> Ir para Polo 1</h1> </div>
            </div>
                  ...
                  isLoginOpen && (
                    <div className="fixed inset-0 lg:relative lg:inset-0 flex items-center justify-center">
                      ...
                      <div className="lg:relative fixed inset-0 overflow-y-auto scroll-pink ">
                        ...
                        <div className='flex flex-col justify-center items-center gap-10 h-full pb-32 pt-29 lg:pt-0 lg:pb-7 lg:rounded-4xl backdrop-blur-md bg-gradient-to-br from-yellow-600 to-yellow-600 lg:rounded-3xl'>
                           ...
                           transition shadow-lg' />
                            ...
                            <div className='relative flex-col gap-4 flex justify-center items-center'>
                              ...
                              <textarea name="text" id="" placeholder='Descreva O Assunto...'
                                ...
                                className='resize-y lg:w-[30vw] lg:h-[30vh] w-[90vw] h-[20vh] sm:h-[20vh]  scroll-pink backdrop-blur-md text-gray-700
                               placeholder:text-gray-700 border border-white/20 px-3 py-2 rounded-xl
                        font-semibold text-xl
                       focus:outline-none transition shadow-lg'></textarea>
                              ...
                              <button
                                ...
                                className="flex gap-2 justify-center items-center   backdrop-blur-md border border-white/20  text-gray-700 px-10 sm:px-5 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full font-bold text-sm transition-all shadow-lg cursor-pointer duration-700 ease-in-out active:scale-70"
                              >
                                <SendHorizontal size={25} className="sm:w-5 sm:h-5" />
                                <span className="font-sans font-semibold">ENVIAR</span>
