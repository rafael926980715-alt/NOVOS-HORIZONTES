  ...
  return (
    ...
    <>
      ...
      <div className="relative w-full min-h-screen overflow-y-hidden bg-gradient-to-br from-yellow-500 to-yellow-600">
        ...
        <div className='z-300 flex flex-col justify-center items-center pt-27 gap-6 lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:bottom-13  fixed bottom-0'>
          ...
          <div className=' flex  flex-col lg:flex-row  items-center  gap-4 w-[100vw] h-[100vh] lg:w-[70vw] lg:h-[70vh] lg:py-89 lg:px-6  lg:rounded-4xl  shadow-lg border border-white/20'>
            ...
            <div className='relative  lg:w-[39vw] lg:h-[70vh]  w-[100vw] h-[100vh] rounded-4xl overflow-hidden overflow-y-auto scroll-pink'>
              ...
              <div className="flex flex-col gap-9">
                ...
                <h1 className='text-gray-700 font-bold font-sans text-5xl  bg-black/10 backdrop-blur-md rounded-4xl py-2 px-5 shadow-lg border'>Instituto Médio Politécnico Novos Horizontes Polo 1</h1>

                <p className='text-gray-700 font-semibold font-sans text-2xl bg-black/10 backdrop-blur-md rounded-4xl py-2 px-5 shadow-lg border border'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus explicabo nulla reprehenderit optio, incidunt, ipsa minima vero consectetur quisquam, deserunt sint rem accusamus odit quos? Enim, quo assumenda. Commodi, perferendis.</p>

                <div className=' flex justify-center items-center gap-1 bg-black/10 backdrop-blur-md rounded-4xl py-2 px-5 shadow-lg border'>
                ...
                <div className='flex flex-col justify-center items-center w-full'>
                  ...
                  <Link 
                  to='/cursos'
                  className=' flex text-gray-700 bg-black/10 backdrop-blur-md rounded-full shadow-lg px-4 py-2 cursor-pointer duration-700 ease-in-out active:scale-70 border'> <h1 className='flex gap-3 font-bold font-sans text-3xl'>Ver Cursos <ArrowRight className=' text-gray-700 text-shadow-lg/10' size={37} /></h1> </Link>


                </div>


                <div className='flex  flex-col lg:flex-row gap-5 justify-between items-center w-full'><h1 className='flex gap-5 text-gray-700 font-bold font-sans text-3xl  bg-black/10 backdrop-blur-md rounded-full shadow-lg px-4 py-2 border'> <PhoneOutgoing className=' text-gray-700 text-shadow-lg/10' size={37} />
                  921 296 545</h1>  <h1 className='flex gap-1 text-gray-700 font-bold font-sans text-3xl border bg-black/10 backdrop-blur-md rounded-full shadow-lg px-4 py-2'> <MessageCircleMore className=' text-gray-700 text-shadow-lg/10' size={37} />
                ...
                >
                  ...
                  <span className="font-sans font-bold flex gap-4 px-6 py-3 border bg-black/10 backdrop-blur-md text-gray-700 shadow-lg rounded-full">PEDIR INFORMACOES < ArrowRight size={29} className="sm:w-9 sm:h-8" /></span>
                  ...
                  isLoginOpen && (
                    <div className="fixed inset-0 lg:relative lg:inset-0 flex items-center justify-center">
                      ...
                      <div className="lg:relative fixed inset-0 overflow-y-auto scroll-pink ">
                        ...
                        <div className='flex flex-col justify-center items-center gap-10 h-full pt-20 pb-32 border border-pink-950  bg-black/10 backdrop-blur-md lg:pb-7 lg:rounded-4xl'>
